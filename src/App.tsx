...
import frImage2 from './assets/me2.jpg';
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8">
              Web developper and, creative web experiences creator
            </p>
            ...
            <div className="grid md:grid-cols-12 gap-12 items-center">
              ...
              <div className="md:col-span-5 relative group">
                <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl transform transition-transform duration-500 hover:scale-105">
                  ...
                  src={frImage2}
                  alt="Profile"
                  className="relative z-10 w-full h-full object-cover  border-4 border-gray-800 p-1 bounce"
                  />  
              ...
              <div className="md:col-span-7 space-y-8">
                <div className="space-y-4">
                  ...
                  Web Developer passionate about creating modern and intuitive web experiences. Specialized in current web technologies. I turn ideas into elegant and high-performance web solutions, with a strong focus on user experience and best development practices.                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 py-8">
                  ...
                  <div className="text-center p-4 bg-gray-800/30 rounded-xl backdrop-blur-sm">
                    <h4 className="text-3xl font-bold text-cyan-400 mb-2">3+</h4>
            ...
            <div className="bg-gray-800/30 p-16 rounded-2xl backdrop-blur-sm transform hover:scale-[1.02] transition-all duration-300">
              <div className="flex items-start space-x-12">
                ...
                <div className="space-y-8 flex-grow">
                  <div>
                    <h3 className="text-4xl font-bold text-white mb-4">ENSA</h3>
                  ...
                  <p className="text-xl text-gray-300 leading-relaxed mb-12">
                    ...
                    and modern web technologies. Specialization in creative web solutionns with innovative features.
                  </p>
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-700">
                    ...
                    <div className="flex flex-wrap gap-4">
                      <span className="px-6 py-3 bg-cyan-500/20 rounded-full text-cyan-400 text-lg">Web Design</span>

                      <span className="px-6 py-3 bg-cyan-500/20 rounded-full text-cyan-400 text-lg">Secure Development</span>
                      <span className="px-6 py-3 bg-cyan-500/20 rounded-full text-cyan-400 text-lg">Innovative web functionnalities</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-800/30 p-8 rounded-xl backdrop-blur-sm">
                ...
                <form action="https://formsubmit.co/thekingM1@outlook.fr" method="POST" className="space-y-4">
                  <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@thekingM1@outlook.fr" className="text-gray-300 hover:text-cyan-400">
                        thekingM1@outlook.fr
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                  ...
                  <div className="pt-6">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a
                        href="https://www.linkedin.com/in/mohamed-kamil-zahiri-5a95b92a5/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-3 bg-gray-900/50 rounded-full hover:bg-gray-700/50 transition-colors"
                      >
